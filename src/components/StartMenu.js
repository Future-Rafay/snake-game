...
const StartMenu = ({ onStartGame }) => {
    ...
    return (
        ...
        >
            ...
            <button
                className="text-sm 3xs:px-4 3xs:py-2 sm:px-6 sm:py-3 sm:text-xl text-white bg-green-500 rounded-lg shadow-md hover:bg-green-600 transition duration-300"
            ...
            <select
                ...
                className="mt-4 text-sm 3xs:px-4 3xs:py-2 sm:px-6 sm:py-3  sm:text-xl text-white bg-green-500 rounded-lg shadow-md hover:bg-green-600 transition duration-300"
            >
